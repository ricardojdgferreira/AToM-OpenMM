...
class OMMSystem(object):
    ...
    def set_barostat(self,temperature,pressure,frequency):
        ...
        """
        if self.keywords.get('MEMBRANE') == 'yes':
            self.barostat = MonteCarloMembraneBarostat(pressure, 400*bar*nanometers, temperature, MonteCarloMembraneBarostat.XYIsotropic, MonteCarloMembraneBarostat.ZFree)
        else:
